package com.wd.tech.mydatepicker;
...
public class DatePicker2 extends LinearLayout {
    ...
    /*public void setRightTitle(boolean flag){
        this.isSignIn = flag;
        if(isSignIn){
            tvEnsure.setText("已签到");
            tvEnsure.setTextColor(MyApp.mContext.getResources().getColor(R.color.colorWhite));
            tvEnsure.setBackgroundDrawable(MyApp.mContext.getResources().getDrawable(R.drawable.box_blue_solid));
        }else{
            tvEnsure.setText("未签到");
            tvEnsure.setTextColor(MyApp.mContext.getResources().getColor(R.color.gray_normal));
            tvEnsure.setBackgroundDrawable(MyApp.mContext.getResources().getDrawable(R.drawable.box_gray_solid));
        }
    }*/
}
