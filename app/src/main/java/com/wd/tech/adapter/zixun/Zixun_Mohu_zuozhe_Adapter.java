...
public class Zixun_Mohu_zuozhe_Adapter extends RecyclerView.Adapter<Zixun_Mohu_zuozhe_Adapter.Holder> {
    List<Zixun_mohu_zuozheBean.ResultBean> list;
    Context context;

    public Zixun_Mohu_zuozhe_Adapter(List<Zixun_mohu_zuozheBean.ResultBean> list, Context context) {
        this.list = list;
