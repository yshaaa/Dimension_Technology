...
public interface Contract {
    ...
    interface IModel{
        ...
        void postInfoHava1(String url, Class cls, Map<String, Object> map, ModelCallBack callBack);
    ...
    interface IPresenter{
        ...
        void startpostInfoHava1(String url, Class cls, Map<String, Object> map);
